...
// ▶️ MOCK do contexto de autenticação
...
describe("SignupForm", () => {
  ...
  describe("handleSubmit function", () => {
    it("deve mostrar toast de erro quando senha é muito fraca", async () => {
      ...
      // Preenche todos os campos com senha fraca
      ...
      fireEvent.changeText(getByLabelText(t.fields.password), "123"); // Senha muito fraca
      fireEvent.changeText(getByLabelText(t.fields.confirmPassword), "123");
      fireEvent.press(getByLabelText(t.accessibility.checkbox)); // Aceita termos
    ...
    it("deve mostrar toast de erro quando senhas não coincidem", async () => {
      ...
      // Preenche todos os campos com senhas diferentes
      fireEvent.changeText(getByLabelText(t.fields.name), "João Silva");
      fireEvent.changeText(getByLabelText(t.fields.email), "joao@test.com");
      fireEvent.changeText(getByLabelText(t.fields.password), "password123");
      fireEvent.changeText(getByLabelText(t.fields.confirmPassword), "password456"); // Diferente
      fireEvent.press(getByLabelText(t.accessibility.checkbox)); // Aceita termos
  ...
  describe("validateEmail function", () => {
    it("deve mostrar erro quando email é inválido", async () => {
      ...
      fireEvent.changeText(emailInput, "email-invalido"); // Email inválido
    ...
    it("não deve mostrar erro quando email é válido", async () => {
      ...
      const emailInput = getByLabelText(t.fields.email);
      fireEvent.changeText(emailInput, "joao@test.com"); // Email válido
    ...
    it("deve mostrar toast de erro no submit quando email tem erro de validação", async () => {
      ...
      // Preenche todos os campos com email inválido
      fireEvent.changeText(getByLabelText(t.fields.name), "João Silva");
      fireEvent.changeText(getByLabelText(t.fields.email), "email-invalido"); // Email inválido
      fireEvent.changeText(getByLabelText(t.fields.password), "password123");
      fireEvent.changeText(getByLabelText(t.fields.confirmPassword), "password123");
      fireEvent.press(getByLabelText(t.accessibility.checkbox)); // Aceita termos
